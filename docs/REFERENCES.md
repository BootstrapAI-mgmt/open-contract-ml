...
Earlier revisions of these documents carried anchors into an internal quote
ledger that is deliberately not published, which left a public reader with no
way to follow the reference. Those anchors have been replaced by the entries
below.
