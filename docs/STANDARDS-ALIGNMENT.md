...
the end. Two claims made in the brief that produced this note turned out to be
...
> **Correction to the brief.** The brief called this "V&V 20-2016". There is no
...
- **Whether determinism is bitwise or seeded-tolerance, and at what tolerance** —
  `A5`, `V011`. This one matters more than it looks: two lanes in this ecosystem
...
> **Correction to the brief.** The brief attributed MLTE to the SEI. The
...
> owner. The brief also gave the PyPI name as `mlte-python`; both `mlte`
...
PhysicsNeMo-CFD evaluation is the obvious way to find out, and is tracked as
card PS04 in `physics-surrogates`.
