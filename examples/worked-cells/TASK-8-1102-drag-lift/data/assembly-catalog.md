# TASK-8-1102 — Assembly Catalog (catalog → physical attributes)
...
"what the model regresses on" — the same separation the deck-trio
discusses for chained surrogates (predicted-coefficients-as-handoff)
