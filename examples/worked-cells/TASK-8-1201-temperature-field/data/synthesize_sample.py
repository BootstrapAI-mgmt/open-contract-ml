"""
TASK-8-1201 Temperature-Field Surrogate -- SAMPLE-DATA SYNTHESIZER
=================================================================
...
This is the arc's first FIELD-output example (slide-9 cell n=1, m=2,
bucket B2). It bridges from TASK-8-1104 peak-temperature (a B1 scalar
...
vocabulary is the SAME seven thermal parameters as TASK-8-1104.
...
TASK-8-1104 used for its scalar peak, now EVALUATED AT EVERY VOXEL of a
...
Each dataset row is:
    ...
    7 input columns   (the same vocabulary as TASK-8-1104)
...
def _sample_design(rng):
    ...
    Identical sampling discipline to TASK-8-1104: the heat-generation power
