"""
TASK-8-2101 Drag-From-Shape-Image Surrogate -- SAMPLE-DATA SYNTHESIZER
======================================================================
Generates an *illustrative* sample dataset for the arc's first
IMAGE-INPUT example (slide-9 cell n=2, m=1, Bucket B2 by input shape).
It bridges from TASK-8-1102 drag-lift (a B1 scalar example) by stepping
...
ASCII-only source by discipline (LESSONS L15 / project memory).
