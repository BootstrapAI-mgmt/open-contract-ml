#!/usr/bin/env python3
"""
synthesize_sample.py — Generate `sample-dataset.csv` for the drag-lift example.
...
The illustrative-numerics discipline applies: figures derived from this
data tell you about the synthesizer, not about CFD.
