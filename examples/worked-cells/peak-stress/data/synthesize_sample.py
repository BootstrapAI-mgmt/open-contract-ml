"""
Peak-Stress Surrogate example — SAMPLE-DATA SYNTHESIZER
===========================================================
...
magnitudes of any specific real bracket. See data-contract.md for the
illustrative-numerics framing.
