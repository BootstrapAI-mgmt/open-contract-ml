"""
THERMAL DOE WORKED INSTANCE -- SAMPLE-DATA SYNTHESIZER
=====================================================
Generates the 720-row full-factorial thermal DOE that the head-to-head
(`run_ht_instance.py`, not included in this repository) fits three
surrogate families to: 5 scalar targets; physics-engineered features
(dT terms and a T^4 radiation term) built at fit time; and a product
that is a bisection inverse -- the clearance that keeps the module
under 120 C.
...
DETERMINISM (the synthesizer must be deterministic)
--------------------------------------------------------------------
