"""G1 -- corpus acceptance gate for PSW04-schema training corpora.

Implements section 4.2 G1 of VERTICALS-BUILD-TEST-VALIDATE-PLAN.md:
...
Usage:
  python corpus_gate.py --corpus <dir>/training_corpus.parquet --rules rules/pv-c2.physics_rules.json --report out/corpus_gate_report.json
...
def main(argv=None) -> int:
    p = argparse.ArgumentParser(description="G1 corpus acceptance gate (PSW04 schema)")
