"""Fail-demos for the safe-load policy (gate G0.4).
...
def test_hostile_bundle_is_live_under_plain_pickle_load(tmp_path, name):
    ...
    This is the call that used to be at model_gate.py:137 and model_gate.py:237.
    ...
    with open(path, "rb") as fh:
        pickle.load(fh)                      # the surface G0.4 removes
